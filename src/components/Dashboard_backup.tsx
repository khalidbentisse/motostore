                                    ...
                                    <tr key={order.id} className="hover:bg-white/5 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase border ${order.status === 'completed'
                                        ...
                                        <td className="px-6 py-4">
                                            {order.status === 'pending' && (
                                                <button
                                                    onClick={async () => {
                                                        const success = await supabaseService.updateOrderStatus(order.id, 'completed');
                                                        if (success) {
                                                    ...
                                                    className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-xs font-bold uppercase transition-colors"
                                                >
                                                    Mark Complete
                                                </button>
                                            )}
